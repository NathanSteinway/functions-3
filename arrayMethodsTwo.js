...
let newNumbers = numbers.forEach((element => {
...
let newCities = cities.filter((element => {
  return element.charAt(element.length - 1) == 'i'
}))
...
let newFruit = fruits.forEach((element => {
  if(element.color === "red"){
    console.log("The fruit with an index of " + fruits.indexOf(element) + " is an apple")
  } else if(element.color === "orange"){
    console.log("The fruit with an index " + fruits.indexOf(element) + " is an orange.")
  } else {
    console.log("The fruit with an index " + fruits.indexOf(element) + " is neither apple or orange.")
  }
}))
...
// The fruit with an index 0 is neither apple or orange.
// The fruit with an index 1 is an orange.
// The fruit with an index 2 is neither apple or orange.
// The fruit with an index of 3 is an apple
...
let newFoods = foods.filter((element) => element.tags.includes("rice")).reduce((acc, curr) => acc + curr.price, 0)
